    ...
    return (
        <div className="result">
                <div className='left'>
                    ...
                    <div className="info">
                        <p>Símbolo: <strong>ÁGUA</strong> </p>
                        <p>O fleumático não se deixa afetar tão facilmente pelas impressões, nem se sente mais inclinado a reagir, e as impressões, por sua parte, logo se desvanecem.<br />
