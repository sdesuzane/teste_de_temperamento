    ...
    return (
        <div className="result">
                <div className='left'>
                    ...
                    <div className="info">
                        <p>Símbolo: <strong>TERRA</strong></p>
                        <p>O melancólico se irrita bem pouco diante das impressões da alma. A reação não se produz nele ou chega depois de certo tempo. As impressões, no entanto, ficam gravadas muito profundamente na alma, sobretudo se se repetem sempre as mesmas.<br/>
                        ...
                        Os melancólicos também precisam ter extremo cuidado para não caírem no ensimesmamento, em uma hipnose interna que o faz se trancar e hiper dimensionar a si mesmo e as coisas que lhe aconteceram, podendo ficar como um cachorro correndo atrás do próprio rabo. Essa tendência perigosa acaba por, naturalmente, trazer à tristeza em conjunto.</p>
                    </div>

                    {/* Corrigindo a div de botão */}
                ...
                {/* Movendo essa div para fora da esquerda */}
                <div className='right'>
                    <img src="assets/melancholic.png" alt="Melancólico" />
                </div>
            </div>
