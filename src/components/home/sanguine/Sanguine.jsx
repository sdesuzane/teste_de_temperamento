    ...
    return (
        <div className="home" id="intro">
            ...
            <div className='left'>
                ...
                <div className="info">
                <p>Símbolo: <strong> AR</strong></p>
                <p>O sanguíneo, assim como o colérico, se irrita fácil e fortemente, sentindo-se, da mesma forma, impulsionado a uma reação rápida; mas a impressão se apaga logo e não fica por muito tempo na alma. Sanguíneo é o típico “fogo de palha”, ele tende a dar uma resposta imediata, mas que, rapidamente, se esvai.<br/>
                ...
                Com relação aos principais defeitos desse temperamento, destaca-se os seguintes: bagunceiro, inconstante, procrastinador. Tem dificuldade com esforço duro e contínuo. É superficial e julga rapidamente ter entendido alguma coisa. Tem alta facilidade de distração, fala muito e ouve pouco.</p>
                </div>
